...
let search = `            Download HTML\n          </button>\n        </template>\n\n        <!-- SCORM -->`;
let replace = `            Download HTML
          </button>
        </template>
        ...
        <template v-else-if="activeTab === 'pdf'">
          <div class="export-info">
            ...
            <div>
              <h4>PDF Document</h4>
              <p>Generate a printable, static PDF version of all slides (videos and interactions disabled). Converts perfectly to a standard presentation handout.</p>
            </div>
          </div>
